    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <%
           UserDetails user=(UserDetails) session.getAttribute("userD");
            ...
            {
        %>
        <a href=""class="btn btn-light my-2 my-sm-0 mr-2" type="submit" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-user-circle" aria-hidden="true"></i><%=user.getName()%></a>
